...
function actions(back, label = 'Далее') {
  return `<p class="error" role="alert" id="form-error"></p><div class="screen-actions"><button type="submit" class="button">${label}</button>${back ? `<a href="#${back}" class="back-button">${icon('arrow-left')} Назад</a>` : ''}</div>`;
}
